...
# set1.remove(500);   print(set1) # remove based on value. throes error if element is not present.
...
# directly print it in print() function.
# also update copys data from set3 to set2.
